...
const state = reactive({
  options:{
    ...
    datas:[
      ...
      {attr:'custoiColor',type:'String',red:'type 为 custom 时自定义按钮的颜色色值。需要注意的是type为 default、dashed、text 类型的按钮不支持',sel:'——',def:"——"},
      {attr:'loading',type:'Boolean',red:'是否为加载状态的按钮，加载状态的icon仅支持这六个(i-icon-loading1 / i-icon-loading2 / i-icon-loading3 / i-icon-loading4 / i-icon-loading5 / i-icon-loading6)，通过 leftIcon / rightIcon 参数配置并确定位置',sel:'true / false ',def:"false"},
